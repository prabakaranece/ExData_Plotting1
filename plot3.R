...
# 2) Name of the plot file as plot3.png
# 3) Create a separate R code file (plot3.R) that constructs the corresponding plot, i.e. code in plot3.R constructs the plot3.png plot. Your code file should include code for reading the data so that the plot can be fully reproduced. You must also include the code that creates the PNG file.
